...
const ProjectCard = ({ img, title, description, link }: ProjectCardProps) => (
  <div className="bg-neutral-900 rounded-lg overflow-hidden group transform transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-red-800/20">
